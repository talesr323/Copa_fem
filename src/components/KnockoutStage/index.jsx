                    ...
                    <div key={jogo.jogo} className={styles.jogo}>
                        ...
                        <h3 className={styles.placar}>
                            <div className={styles.mandante_box}>
                                {jogo.mandante}
                                <img src={`/bandeiras/${jogo.sigla_mandante.toLowerCase()}.png`} alt=''></img>
                            </div>
                            ...
                            <div className={styles.visitante_box}>
                                {jogo.visitante}
                                <img src={`/bandeiras/${jogo.sigla_visitante.toLowerCase()}.png`} alt=''></img>
                            </div>
                        </h3>
                        <div className={styles.tempo_extra}>
                            {
                                ...
                                <div className={styles.centralizar}>
                                    ...
                                    <span>Penaltis? {jogo.penaltis} / Placar Penaltis : {jogo.placar_penaltis}</span>
